...
#         self.age = age
#         self.statut = statut
#         self._motDePasse = None  # initialisation sécurisée
#         self.nom_utilisateur = None  # initialisation propre
...
#         self.mot_de_passe = mot_de_passe  # utilise le setter ici
...
# statut = input("Quel est votre statut (ex: Utilisateur ou Employe) ? : ")
